...
ClientData::ClientData(int accountNumberValue, const string& lastName, 
   const string& firstName, double ageValue)
   : accountNumber(accountNumberValue), age(ageValue) {
...
// get age value
double ClientData::getage() const {return age;}

// set age value
void ClientData::setage(double ageValue) {age = ageValue;}
